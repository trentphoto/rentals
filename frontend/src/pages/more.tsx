...
export default function CamerasPage() {
  ...
  React.useEffect(() => {
    ...
    fetch(`${base}/products/category/more`)
        .then(res => res.json())
          ...
          <div className="container">
            <div className="flex flex-col justify-center items-center p-20 shadow-xl relative rounded-xl overflow-hidden">
              ...
              <div className='text-white z-20 w-full'>
                <h1 className="text-4xl font-serif font-normal mb-2">More Equipment</h1>
                <p className="text-stone-300">Looking for something else? We have a wide selection of equipment for your next shoot.</p>
              </div>
          ...
          <div className="container">
            ...
            <div className="grid lg:grid-cols-5 gap-12">
              ...
              <div className="lg:col-span-3">
                ...
                <h2 className='mb-4'>Stabilizers, Drones, & Lighting Equipment</h2>
